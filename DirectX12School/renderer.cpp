...
void CRenderer::Draw()
{
	...
	//リソースの状態をプレゼント用からレンダーターゲット用に変更
	SetResourceBarrierGeometry(D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE,
